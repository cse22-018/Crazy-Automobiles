	...
	function enterItems() {
		...
		else if(inputValue == "Puma Easy Rider") {
			count = 2;
		}
		else if(inputValue == "Puma Scuderria") {
			count = 3;
		}
		else if(inputValue == "Puma Suede") {
			count = 4;
		}
		...
		switch(count) {
			case 1: 
				createItem("../puma shoes/Easy-Rider-Vintage-Sneakers.jpg", "Sneaker Puma Easy Rider", "P2 199.00"); 
				createItem("../puma shoes/Scuderia-Ferrari-Drift-Cat-11-Mens-Sneakers.jpg", "Sneaker Puma Scuderia Ferrari", "P2 900.00");
				createItem("../puma shoes/Suede-Classic-Sneakers.jpg", "Sneaker Puma Suede Original", "P1 700.00"); 
	...
	function clearSearch() {
		...
		if(document.getElementById("child").hasChildNodes()) {
			document.getElementById("child").innerElement = "";
		}
